...
class IncomingView extends GetView {
  ...
  Widget build(BuildContext context) {
    ...
    var keyHeight = MediaQuery.of(context).size.height / 9;
    var keyWidth = MediaQuery.of(context).size.width / 4;
              ...
              Container(
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: ExactAssetImage('assets/download.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ...
              Positioned(
                ...
                child: DragTarget<String>(
                  ...
                  onAccept: (data) {
                    isDropped.value = true;
                    // print(data);
                    Get.find<InsertRoomController>().answerVideoCall();
                  },
                ),
              ),
            ],
